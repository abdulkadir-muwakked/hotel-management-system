...
export default function RoomsTable() {
  ...
  const getActiveOrUpcomingReservations = (reservations) =>
    Array.isArray(reservations)
      ? reservations.filter((r) => dayjs(r.checkOut).isSame(today) || dayjs(r.checkOut).isAfter(today))
      : [];
    ...
    <Table>
      ...
      <TableBody>
        {sortedRooms.map((room, idx) => {
          ...
          const activeReservations = getActiveOrUpcomingReservations(room.reservations);
          return (
            <TableRow
              key={
                room.id
                  ...
                  activeReservations.map((reservation) => {
                    ...
                    return (
                      <div key={reservation.id} className="mb-2">
                        <div>
                          {checkIn.format("YYYY-MM-DD")} - {checkOut.format("YYYY-MM-DD")}
                        </div>
